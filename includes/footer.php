<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office:kutus bussiness centre.<br>
				463-10300 kutus, KERUGOYA.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:+254-710863126">+254-710863126</a>
				</div>
				<div class="email">
					Email:
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="developer">
				Dev by Philip Ndirangu
			</div>

			<div class="designby">
				Design by Philip Ndirangu
			</div>
		</div>
	</div>
</footer>
